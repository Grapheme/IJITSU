...
foreach ($wheels_images as $img) {
    ...
    #    continue;
    if (!isset($temp[$img->wheel_id])) $temp[$img->wheel_id] = array();
            ...
            <div class="content col-4">
                <div class="holder">
                    ...
                    <div class="wrapper">
                        ...
                        if (!isset($wheels_images[$wheel->id]) || !count($wheels_images[$wheel->id])) continue;
                        ...
                        ?>
                                --><a name="id-{{ $wheel->id }}" href="" class="col">
                            <div style="background-image:url('{{ $image_thumb }}');" class="visual">
                                <div id="id-{{ $wheel->id }}"></div>
                            </div>
                            ...
                            <div class="detail">
                                <div class="holder">
                                    <img src="{{ Config::get('site.theme_path') }}/images/ico-cross.png" class="close">
                                        ...
                                        @if (count($colors_images))
                                            ...
                                            <div class="colors">
                                                @foreach ($colors_images as $color)
                                                    <div data-big-img="{{ $color->image->full() }}" data-color-id="{{ $color->id }}" class="unit">
                                            ...
                                            @foreach ($colors_images as $color)
                                                ...
                                                if (count($temp)) {
                                                    foreach ($temp as $model) {
                                                        ...
                                                        if (!isset($models[$first_letter])) $models[$first_letter] = array();
                                                        $models[$first_letter][] = $model;
                                                    }
                                                }
                                                ?>
                                                <div class="models models-{{ $color->id }}">
                                                    <div class="left">
